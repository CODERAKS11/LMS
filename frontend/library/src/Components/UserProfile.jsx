...
const UserProfile = () => {
  ...
  // Department-based book recommendations
    ...
    IT: [
      {
        ...
        reason: "Essential guide to software construction.",
      },
      {
        id: "it002",
        title: "The Mythical Man-Month",
        author: "Frederick Brooks",
        reason: "Classic essays on software project management.",
      },
      {
        id: "it003",
        title: "Designing Data-Intensive Applications",
        author: "Martin Kleppmann",
        reason: "Covers modern databases and distributed systems.",
      },
      {
        id: "it004",
        title: "Clean Code",
        author: "Robert C. Martin",
        reason: "Fundamentals of writing better code.",
      },
      {
        id: "it005",
        title: "Grokking Algorithms",
        author: "Aditya Bhargava",
        reason: "Accessible introduction to key algorithms.",
      },
    ],
    ComputerScience: [
      {
  ...
  // Predefined badge names based on reading achievements
  const BADGE_NAMES = {
    // Reading milestones
  ...
  // Helper to extract text from character-based object structure
  ...
  // Improved helper function to extract meaningful badge/milestone name
  const getAchievementName = (item, type = 'badge') => {
    ...
    if (typeof item === 'object' && item !== null) {
      ...
      const possibleFields = ['badgeType', 'milestoneType', 'achievement', 'title'];
  ...
  const formatCustomName = (str) => {
    ...
    if (strString.length > 10 && (strString.includes('_') || /^[0-9a-f]{24}$/i.test(strString))) {
  ...
  const getMilestoneEmoji = (milestoneName) => {
    ...
    if (milestoneName.includes('2024') || milestoneName.includes('2025')) return '📅';
  ...
  const fetchUserData = useCallback(async () => {
    ...
    try {
      ...
      if (userData && userData.name) {
        ...
        console.log("Badges data:", userData.badges);
        console.log("Milestones data:", userData.milestones);
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-10 px-4">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="p-6">
                      ...
                      .map((book, index) => (
                        <li key={index} className="border-b pb-4">
                          ...
                          <div className="bg-gray-100 p-2 mt-2 rounded-md">
                            ...
                            {book.renewalHistory && Array.isArray(book.renewalHistory) && book.renewalHistory.length > 0 ? (
          ...
          {activeTab === "recommended" && (
            <div className="bg-white rounded-lg shadow-md">
              <div className="p-6">
                <h2 className="text-2xl font-bold text-gray-800 mb-2">📚 Recommended Reading List</h2>
                <p className="text-gray-600 mb-6">
                  Curated book recommendations for{" "}
                  <span className="font-semibold text-blue-600">{user.department}</span> department
                </p>
                ...
                {recommendedBooks.length > 0 ? (
                        ...
                        <div className="flex justify-between items-start">
                          ...
                          <button
                            onClick={() => {
                              ...
                              toast.info(`Searching for "${book.title}" in catalog...`);
                            }}
                  ...
                  <div className="text-center py-8">
                    <p className="text-gray-500">No recommendations available for your department.</p>
                    <button
                      onClick={() => setActiveTab("profile")}
        ...
        {/* Reading Achievements Section - FIXED */}
        {activeTab === "profile" && (
          <div className="bg-yellow-50 p-4 rounded-lg shadow-md mt-6">
            ...
            {/* Badges Section */}
            <div className="mt-4">
              <h4 className="text-lg font-semibold mb-3">🏅 Badges Earned</h4>
              {safeBadges.length > 0 ? (
                ...
                <p className="text-gray-500">No badges earned yet. Start reading to earn badges!</p>
              )}
            </div>

            {/* Milestones Section */}
            <div className="mt-6">
              <h4 className="text-lg font-semibold mb-3">🎯 Milestones Reached</h4>
              {safeMilestones.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {safeMilestones.map((milestone, idx) => {
                    const milestoneName = getAchievementName(milestone, 'milestone');
                      ...
                      >
                        <div className="flex justify-between items-start">
                          <div>
                            ...
                            {milestone.earnedAt && (
                              <p className="text-xs text-gray-500 mt-1">
                                Achieved: {formatBadgeDate(milestone.earnedAt)}
                              </p>
                            )}
                          </div>
                        </div>
                ...
                <p className="text-gray-500">No milestones reached yet. Keep reading to reach milestones!</p>
              )}
            </div>
          </div>
        )}
